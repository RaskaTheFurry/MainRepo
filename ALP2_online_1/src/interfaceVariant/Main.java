...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ShapeInterface> shapes3 = new ArrayList<>(); //dynamicke pole objektov které implementují ShapeInterface
        //muze obsahovat colkoli, co je typove kompatibilni s ShapeInterface (Shape, Circle, Rectangle)
